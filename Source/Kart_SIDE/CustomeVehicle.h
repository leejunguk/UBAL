...
#include "CustomeVehicle.generated.h"
 ...
 */
UCLASS()
class KART_SIDE_API ACustomeVehicle : public AWheeledVehicle
{
...
public:
	...
	UPROPERTY(Category = Teleport, VisibleDefaultsOnly, BlueprintReadWrite)
		bool bIsTeleportNow;
